...
```
- block-tier capture (today set): headers-184127-184136, 3 external boxes, epoch-block-184064 (params in force at 184137). Full block with ADProofs: pending digest side-sync.
...
- block-184137-full.json: real proofBytes, blake2b256==adProofsRoot VERIFIED; regenerated locally from rust UTXO state (genesis replay — no testnet peer keeps ADProofs).
