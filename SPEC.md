...
corpus at scale**, since grown by authored gap-fillers: **2,125 entries across 152 files**
(**spec** 2,026/119 blessed by `sigma-state` from its language specification + **authored**
99/33), version-split into **v5** (1,793 — the cumulative v5/mainnet surface) and **v6**
(332 — the v6 new-feature surface); a JSON-Schema gate validates all
152. The conformer layer is live: `./conform` runs a **5-way** (Rudolph · Dasher · Blitzen
