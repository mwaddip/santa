...
- ✅ **A blessed eval corpus — 2,207 entries across 166 vector files**: 2,026 produced by
  the JVM reference interpreter (`sigma-state`) from its own language specification, plus
  181 authored gap-fillers (oracle-blessed, never spec-copied); version-split into **v5**
  (1,830 entries — the cumulative v5/mainnet method surface)
